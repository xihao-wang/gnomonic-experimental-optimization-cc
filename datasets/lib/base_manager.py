        ...
        for sequence in sequences:
            ...
            if max_images is None or max_images == "all":
                ...
                if max_images >= total_available:
                    ...
                    # Evenly spread samples across the full sequence
                    ...
                    num_to_visualize = len(annotation_files)
                    viz_mode = f"{num_to_visualize}/{total_available} (spread, step={step:.1f})"
                else:
                    num_to_visualize = max_images
                    viz_mode = f"{num_to_visualize}/{total_available} (first {num_to_visualize})"

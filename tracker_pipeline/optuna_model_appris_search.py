...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--keep-all-trials", action="store_true", help="Keep every trial output. By default only best/summary data are kept.")
...
def main() -> None:
    ...
    def objective(trial) -> float:
        ...
        for seq in args.sequences:
            ...
            _run(cmd, env, work_root / "logs" / f"{exp_name}_{seq}_tracker.log")
